                ...
                <div class="container">
					...
					if (!isset($_SESSION['id'])){ ?> 
						  ...
						  <li class="divider-vertical"></li>
								<li class="">
								<a  rel="tooltip"  data-placement="bottom" title="Laman UtamaS" id="home" href="dashboardAdmin.php"><i class="icon-home icon-large"></i>&nbsp; Laman Utama</a> 
								</li>
						  <li class="divider-vertical"></li>
								<li class="">
					...
					<li class="active"><a  rel="tooltip"  data-placement="bottom" title="Home" id="home1"  href="dasboardAdmin.php"><i class="icon-home icon-large"></i></a></li>
					<li>
						<a href="dasboard.php"> Selamat Datang:&nbsp;
						<strong class="name1"><?php echo $row['UserName']?></strong></a>
					</li>
					<!-- <li>
