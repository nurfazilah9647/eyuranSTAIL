<div class="left-sidebar bg-black-300 box-shadow ">
  ...
  <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                           ...
                                           <li><a href="add-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Add Enrollment </span></a></li>
                                           <a href="manage-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Enrollment </span></a></li>
                                        </ul>
                                    </li>
   <li class="has-children">
