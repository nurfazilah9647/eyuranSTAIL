	...
	<form class="form-horizontal" method="post">
					<div class="control-group">
						<label class="control-label" for="inputEmail">Trans</label>
						<div class="controls">
						<input type="text"  name="trans" placeholder="trans" value="<?php echo $extra2_row['trans']; ?>" readonly >
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="inputPassword">Item ID</label>
						<div class="controls">
					...
					<div class="control-group">
						<div class="controls">
						<button name="edit" type="submit" class="btn btn-success"><i class="icon-save icon-large"></i>&nbsp;&nbsp; Completed</button>
						</div>
					</div>
    </form>
		</div>
