	<div id="edit_grade<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<form class="form-horizontal" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<strong><?php echo $subject_row['SubjectId'];  ?></strong>
				</div>
			</div>
			<div class="control-group">
				<?php
