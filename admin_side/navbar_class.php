...
<?php
$user_query  = mysqli_query($dbcon, "SELECT * from admin where id = '$session_id'")or die(mysqli_error($dbcon));
  ...
  <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li class="active"><a href="class.php"><i class="icon-file icon-large"></i>&nbsp;Kelas</a></li>
                    <li><a href="subject.php"><i class="icon-file icon-large"></i>&nbsp;Yuran</a></li>
